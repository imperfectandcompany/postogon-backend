               ...
               <ul>
                  <li>
                     <form method="post" action="./home" class="flex items-center <?php if($result != "global"){echo "px-3";}?> hover:text-gray-400 duration-200 mb-4">
                        <button type="submit" name="view" value="global" class="focus:outline-none <?php if($result == "global"){ echo "font-bold";} ?>">Global</button>
                     </form>
                  </li>
                  <li>
                     <form method="post" action="./home" class="flex items-center <?php if($result != "all"){echo "px-3";}?> hover:text-gray-400 duration-200 mb-4">
                        <button type="submit" name="view" value="all" class="focus:outline-none <?php if($result == "all"){ echo "font-bold";} ?>">All</button>
                     </form>
                  </li>				  
                  <li>
                     <form method="post" action="./home" class="flex items-center <?php if($result != "feed1"){echo "px-3";}?>  hover:text-gray-400 duration-200 mb-4">
                        <button type="submit" name="view" value="feed1" class="focus:outline-none <?php if($result == "feed1"){ echo "font-bold";} ?>">Feed One</button>
                     </form>
                  </li>
                  <li>
                     <form method="post" action="./home" class="flex items-center <?php if($result != "feed2"){echo "px-3";}?>  hover:text-gray-400 duration-200 mb-4">
