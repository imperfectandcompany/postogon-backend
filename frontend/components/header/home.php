            <div class="z-50 flex justify-end flex-shrink-0 px-6 py-4">
			<div class="flex mr-auto">
               <a href="."><img class="h-8 w-8" style="filter:brightness(0.1)" src="<?php if($GLOBALS['url_loc'][2]){ echo ".";} ?>./assets/logo.svg" alt="postogon logo"></a>
