<?php
   ...
   <div class="lg:flex">
      ...
      <div id="content-wrapper" class="min-w-0 w-full  sm:px-6 xl:px-8 top-10 pb-16 lg:static lg:max-h-full lg:overflow-visible">
	  <header id="header" class=" hidden lg:block top-10 pb-10 lg:pt-10 lg:pb-14 font-medium text-base sm:px-3 xl:px-5 lg:text-sm pb-10 lg:pt-10 lg:pb-14 ">
            ...
            <section>
               ...
               <div class="bg-white dark:bg-dark dark:text-light">
