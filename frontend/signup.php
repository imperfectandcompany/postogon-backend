...
<?php endif; ?>
  ...
  <div class="relative w-full">
	...
	<input type="password" id="password" autocomplete="off" name="signup_password" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 js-password px-3 pb-3"/>	
  </div>
                </div>
                ...
                <button type="submit" name="createaccount" class="border border-purple-600 bg-white hover:bg-gray-100 hover:border-purple-300 hover:text-purple-400 text-purple-500 font-bold py-2 focus:outline-none rounded shadow-sm hover:shadow-md transition duration-200">Sign Up</button>
            </form>
        </section>			
                <br>
                <hr>
			<section>
                ...
                <a href="./login" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 focus:outline-none rounded shadow-md hover:shadow-xl transition duration-200">Sign In</a>
                </div>
			</section>
    </main>	
<!-- Imprint -->
