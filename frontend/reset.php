...
<?php endif; ?>
        ...
        <section>
            <form class="flex flex-col" method="POST">
                ...
                <button type="submit" name="resetpassword" value="Reset Password" class="border border-purple-600 bg-white hover:bg-gray-100 hover:border-purple-300 hover:text-purple-400 text-purple-500 font-bold py-2 focus:outline-none rounded shadow-sm hover:shadow-md transition duration-200">Send Email</button>
            </form>
        </section>			
                <br>
                <hr>
