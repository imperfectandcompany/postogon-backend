...
<div class=" md:block body-bg min-h-screen pt-12 md:pt-20 pb-6 ox-2 md:px-0" style="font-family:'Lato', sans-serif;">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg lg:shadow-2xl md:shadow-lg sm:shadow-sm">
        <section>
            <h3 class="font-bold text-2xl pb-8 text-center">Sign up for Postogon</h3>
        ...
        <section class="">
            <form class="flex flex-col" method="POST" action="">
                ...
                <button class="bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-2 focus:outline-none rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign Up</button>
            </form>
                <br />
                <hr />
