				...
				<div class="flex flex-col">
                  <div class="flex flex-row items-baseline">
                     ...
                     <h1 class="text-xl font-bold flex"><?php echo $profile; ?></h1>
				  					<!-- show users username --->					 
                     <h2 class="ml-1 text-xs text-gray-400 transition hover:text-gray-500">@<?php echo $profile;
					 //if user is verified, list that the user is verified
					 if($verified){echo 'verified'; } ?></h2>
                  </div>
                  <!-- Username -->
				  <div class="flex flex-col">
				  ...
				  <?php if($isFollowingMe && !$isMutual): ?>
				                       <div class="mt-1"><span class="p-1 text-xs bg-gray-100 text-gray-800 font-semibold transition hover:text-gray-700">Follows you</span></div>
				  <?php endif; ?>
				  <?php if($isFollowingMe && $isMutual): ?>
				                       <div class="mt-1"><span class="p-1 text-xs bg-gray-100 text-gray-800 font-semibold transition hover:text-gray-700">Mutual followers</span></div>
				  <?php endif; ?>				  
				  <?php endif; ?>
				  <?php endif; ?>
